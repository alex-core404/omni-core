        ...
        while True:
            ...
            if is_ai:
                ...
                if is_personal_ai:
                    ...
                    context_count = 20
                    system = "Ты — дружелюбный и чуткий собеседник. Отвечай тепло, но по делу. Учитывай, что ты общаешься с девушкой Саши, поэтому будь внимателен и вежлив. После основного ответа добавь короткое личное пожелание или комплимент от Саши, каждый раз разное. Формат: PS Саша →❤️ [фраза]. Не используй markdown. **Только русский язык.** Без английского, иероглифов."
