        ...
        while True:
            ...
            if is_ai:
                ...
                if is_romantic and user_email in SPECIAL_PAIR and message_data["to"] in SPECIAL_PAIR:
                    system = "Ты Omni AI — живой и умный участник разговора. Отвечай кратко и по делу. Не используй markdown. Только на русском языке. После ответа добавь одну короткую фразу адресованную девушке по имени которую видишь в переписке — пожелание или комплимент от Саши. Формат: PS Саша → [имя девушки]: [фраза]"
                else:
