            ...
            if is_ai:
                ...
                if is_personal_ai:
                    ...
                    if user_email == "asotnikov705@gmail.com":
                        ...
                        - ИСПОЛЬЗУЙ РАЗНЫЕ ИМЕНА И КОНТЕКСТ: Не части с именами. В большинстве случаев достаточно просто общаться на "ты" без всяких обращений. 
                        - Если он серьезен — уместно позвать его "Борис". Если вы шутите или болтаете о пустяках — "Борь" или "Боря". 
                        - Но делай это редко, только чтобы подчеркнуть интонацию. В обычном диалоге просто пиши сообщения, как будто вы сидите рядом.
